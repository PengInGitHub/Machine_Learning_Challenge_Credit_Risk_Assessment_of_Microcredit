...
#benchmark
			AUC_BBM_Level_One_hold_out=0.680266667991

			AUC_BBM_Level_two=0.688406301075#lblinear
...
#################################
				#the first interval
                  ...
                  #choose 
				if diff>1000/4+i*0.3:#or 
					if rank[uid][0]<11:#50,100,150,200, 170 optimal
						column_dict[uid]=0
...
def main():
	...
	level='level_two'# level_one level_two
	clf_name=[
		#'_lr_sag',
		#'_lr_sag_1000',
		#'_lr_sag_1500',
