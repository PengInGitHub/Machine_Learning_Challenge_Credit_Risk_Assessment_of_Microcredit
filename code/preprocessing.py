...
class Preprocessing():
	...
	class: Preprocessing
     ...
     this class is to do a variety of transformations on the raw data  so that it is ready for modeling
	...
	:log_move: move the entire column to the right by the min value in the column, then do log10 trans, this avoids neg values in original data
